...
func runCommandWithUser(uid uint32, gid uint32, name string, waitTime int, arg ...string) (string, error) {
...
// RunCommandWithUser run command, return the output of command
func RunCommandWithUser(name string, waitTime int, uid uint32, gid uint32, arg ...string) (string, error) {
	return runCommandWithUser(uid, gid, name, waitTime, arg...)
}
