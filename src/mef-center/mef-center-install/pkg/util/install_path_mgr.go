...
func (cpm *ConfigPathMgr) GetThirdPartyRootCaDir() string {
	return filepath.Join(cpm.GetCertMgrRootCaDirPath(), common.ThirdPartyCertName)
}
...
func (cpm *ConfigPathMgr) GetHubSrvKeyPath() string {
	return filepath.Join(cpm.GetCertMgrRootCaDirPath(), common.WsSerName, RootKeyFileName)
}
...
func (cpm *ConfigPathMgr) GetNorthernCertPath() string {
	return filepath.Join(cpm.GetCertMgrRootCaDirPath(), common.NorthernCertName, RootCrtName)
}

// GetNorthernCrlPath returns the crl path of the 3rd party
func (cpm *ConfigPathMgr) GetNorthernCrlPath() string {
	return filepath.Join(cpm.GetCertMgrRootCaDirPath(), common.NorthernCertName, CrlName)
}

// GetImageCertPath returns the cert path of the image repository ca
func (cpm *ConfigPathMgr) GetImageCertPath() string {
	return filepath.Join(cpm.GetCertMgrRootCaDirPath(), common.ImageCertName, RootCrtName)
}

// GetSoftwareCertPath returns the cert path of the software repository ca
func (cpm *ConfigPathMgr) GetSoftwareCertPath() string {
	return filepath.Join(cpm.GetCertMgrRootCaDirPath(), common.SoftwareCertName, RootCrtName)
}
...
func (cpm *ConfigPathMgr) GetApigRootPath() string {
	return filepath.Join(cpm.GetCertMgrRootCaDirPath(), ApigDirName, RootCrtName)
}

// GetCertMgrRootCaDirPath returns the root-ca dir of cert-manager
func (cpm *ConfigPathMgr) GetCertMgrRootCaDirPath() string {
	return filepath.Join(cpm.GetComponentConfigPath(CertManagerName), RootCaDir)
}
