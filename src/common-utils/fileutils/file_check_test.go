...
func TestCheckOwnerAndPermission(t *testing.T) {
	...
	convey.Convey("Check Owner And Permission: right not correct", t, func() {
		...
		convey.So(err, convey.ShouldResemble,
			fmt.Errorf("check file /tmp failed: path /tmp's file mode dtrwxrwxrwx unsupported"))
	})
...
func testRealFileCheckParent() {
	...
	convey.Convey("file mode check failed", func() {
		...
		convey.So(err, convey.ShouldResemble,
			fmt.Errorf("check file %s failed: path /tmp's file mode dtrwxrwxrwx unsupported", filePath))
	})
...
func testRealDirCheckParent() {
	...
	convey.Convey("file mode check failed", func() {
		...
		convey.So(err, convey.ShouldResemble,
			fmt.Errorf("check file %s failed: path /tmp's file mode dtrwxrwxrwx unsupported", tmpDir))
	})
