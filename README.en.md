...
Before installation and use, users need to understand the installation notes and prepare the installation environment. For details, see [Installing MEF](docs/en/user_guide/installation_guide.md).
...
For API reference details, see [API Reference](./docs/en/user_guide/RESTful.md).

## FAQ

For related FAQs, see [FAQ](docs/en/user_guide/faq.md).
