...
// Get3rdPartyCertPath returns the cert path of the 3rd party
func (cpm *ConfigPathMgr) Get3rdPartyCertPath() string {
	return filepath.Join(cpm.GetMefCertsDirPath(NginxManagerName), ThirdPartyName+CertSuffix)
}
