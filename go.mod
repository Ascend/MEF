...
replace (
	...
	huawei.com/mindx/common/utils => codehub-dg-y.huawei.com/m30026943/common-utils.git/utils v0.1.6
	huawei.com/mindx/common/x509 => codehub-dg-y.huawei.com/m30026943/common-utils.git/x509 v0.1.8
