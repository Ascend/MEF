...
CFLAGS_ENV="-Wall -fstack-protector-strong -fPIE -fPIC -D_FORTIFY_SOURCE=2 -O2 -Wl,-z,relro -Wl,-z,now -Wl,-z,noexecstack -s"
CXXFLAGS_ENV="-Wall -fstack-protector-strong -fPIE -fPIC -D_FORTIFY_SOURCE=2 -O2 -Wl,-z,relro -Wl,-z,now -Wl,-z,noexecstack -s"
